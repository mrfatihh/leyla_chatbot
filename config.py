...
TOKEN = os.environ.get("8135270472:AAHeDZich12UzbFugDs_dvG4fCnhONhIyhM", None) # Dapatkan di @botfather
OWNER = os.environ.get("7947671104", "x") # Isi dengan username kalian tanpa tanda @
